...
setup(name         = "python-sipsimple",
      ...
      packages     = ["sipsimple", "sipsimple.streams", "sipsimple.clients", "sipsimple.clients.configuration", "sipsimple.applications", "sipsimple.configuration", "sipsimple.configuration.backend"],
      package_data = {
