    ...
    def accept(self, streams, is_focus=False):
        ...
        try:
            ...
            if e.data.prev_state in ('incoming', 'early'):
                ...
                notification_center.post_notification('SIPSessionDidProcessTransaction', self, NotificationData(originator='remote', method=e.data.getattr('method', 'INVITE'), code=200, reason='OK'))
                self.end_time = datetime.now()
