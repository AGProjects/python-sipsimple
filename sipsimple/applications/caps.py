...
from sipsimple.applications import XMLStringElement, XMLElement, XMLElementChild, XMLEmptyElement, XMLListElement, XMLAttribute
from sipsimple.applications.presdm import PIDFApplication, ServiceExtension, Service, DeviceExtension, Device
