...
class AccountConfig(ConfigSection):
    _datatypes = {"sip_address": str, "password": str, "display_name": str, "outbound_proxy": OutboundProxy, "xcap_root": str, "use_presence_agent": datatypes.Boolean, "sip_subscribe_interval": int}
    sip_address = None
    password = None
    display_name = None
    outbound_proxy = None
