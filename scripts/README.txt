...
If the outbound_proxy option is set the SIP messages will always go through
it. Otherwise the outbound proxy is the SIP registrar for the account's own
...
You may also define multiple accounts and select one of them with -a NAME
